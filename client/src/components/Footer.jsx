...
function Footer() {
  // Define the slightly darker light olive green color
  const lightOliveGreen = '#7b8465'; // A slightly darker shade of olive green than before

  return (
    <footer className="text-white py-10" style={{ backgroundColor: lightOliveGreen }}> {/* Applied light olive green */}
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8"> {/* Changed to md:grid-cols-2 for 2 columns */}
        ...
        <div className="col-span-1">
          ...
          <p className="text-gray-100 text-sm mb-4"> {/* Adjusted text color for better contrast */}
